  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-[#f0f4f8] to-[#e8f0fa]">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="animate-float absolute -top-20 -left-20 w-72 h-72 rounded-full bg-[#d4e8fd]/30" />
        <div className="animate-float-delayed absolute top-1/3 -right-16 w-56 h-56 rounded-full bg-[#b3d4fc]/20" />
        <div className="animate-float-slow absolute -bottom-10 left-1/4 w-40 h-40 rounded-full bg-[#e8f4fd]/40" />
      </div>
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center relative">
        <div className="text-center max-w-md px-8">
          ...
          <p className="text-[#6b7c93] text-lg mb-10">安全、高效的私有云存储解决方案</p>
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative">
        <div className="w-full max-w-[420px] animate-fade-in-up">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-[20px] shadow-[0_8px_32px_rgba(0,0,0,0.08)] p-8">
            <h2 className="text-2xl font-semibold text-[#2c3e50] mb-1">欢迎回来</h2>
            <p className="text-[#6b7c93] text-sm mb-6">登录你的 MediaDrive Pro 账号</p>
            ...
            <p className="text-center text-sm text-[#6b7c93] mt-6">
              没有账号？{' '}
              <Link to="/register" className="text-[#5b8db8] font-medium hover:text-[#4a7da8] transition-colors">注册</Link>
            </p>
          </div>
        </div>
      </div>
